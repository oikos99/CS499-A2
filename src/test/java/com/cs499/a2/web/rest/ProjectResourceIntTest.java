...
import com.cs499.a2.domain.Project;
import com.cs499.a2.repository.ProjectRepository;
...
public class ProjectResourceIntTest {
    ...
    private static final String DEFAULT_NAMEE = "AAAAAAAAAA";
    private static final String UPDATED_NAMEE = "BBBBBBBBBB";
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getNamee()).isEqualTo(DEFAULT_NAMEE);
    ...
    public void getAllProjects() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].namee").value(hasItem(DEFAULT_NAMEE.toString())))
    ...
    public void getProject() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects/{id}", project.getId()))
            ...
            .andExpect(jsonPath("$.namee").value(DEFAULT_NAMEE.toString()))
    ...
    public void updateProject() throws Exception {
        ...
        Project testProject = projectList.get(projectList.size() - 1);
        assertThat(testProject.getNamee()).isEqualTo(UPDATED_NAMEE);
